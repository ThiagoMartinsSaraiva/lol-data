        ...
        {champions.map((champion) => (
          ...
          >
            <div className="image-container">
              <img
                src={`https://ddragon.leagueoflegends.com/cdn/12.11.1/img/champion/${champion.image.full}`}
                loading="lazy"
          ...
          <>
            <div className="modal-header">
              <div className="champion-profile-image">
                <img
                  src={`https://ddragon.leagueoflegends.com/cdn/12.11.1/img/champion/${currentChampion.image.full}`}
                  loading="lazy"
                />
              </div>
            </div>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <img
                          src={`https://ddragon.leagueoflegends.com/cdn/12.11.1/img/passive/${currentChampion.passive.image.full}`}
                          loading="lazy"
                        />
